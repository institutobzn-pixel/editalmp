...
|---|---|---|---|
| 1 | Fundamentos de IA, Engenharia de Prompt e Direcionamento | O que a IA generativa faz e não faz; limites, erros, privacidade, LGPD e ética; **engenharia de prompt: estrutura contexto–tarefa–formato–exemplo, refinamento iterativo, prompts reutilizáveis para serviços**; **panorama das principais redes sociais — Instagram, YouTube, Facebook, LinkedIn e TikTok: características, públicos e formatos de cada uma** — como base para a escolha do foco de atuação e das plataformas do aluno | Biblioteca pessoal de prompts de serviço + quadro-guia das redes + foco de atuação definido |
...
| 5 | Edição e Composição Visual Avançada | Montagens, mockups, banners, artes para campanhas e datas comemorativas, adaptadas ao formato de cada rede | 2º serviço no portfólio: campanha visual |
...
| 9 | Produção de Vídeo Curto para Redes | Edição assistida, legendas automáticas, cortes e vídeos verticais para Instagram, TikTok e Reels | 4º serviço no portfólio: vídeo curto editado |
...
- **Diferença clara em relação ao Curso "IA para Empreendedores":** aquele usa IA para gerir um negócio já existente; este **cria uma nova atividade de renda a partir do zero**, cujo produto é o próprio serviço prestado a terceiros. Não há sobreposição de entregáveis.
- **Ponte com o Autonomia 60+:** os egressos são a fonte prioritária de monitores intergeracionais — apoiar a pessoa idosa com tecnologia é um ensaio real do serviço que passam a vender.
- **Ponte com o território:** os clientes-piloto do Bloco IV são preferencialmente pequenos comércios e empreendedores locais (inclusive egressos do Curso "IA para Empreendedores"), fechando o circuito do programa.
